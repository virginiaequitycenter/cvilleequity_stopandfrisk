...
Navigate to additional pages for further analysis on detentions compared to the Charlottesville population, Stop and Frisk rates, the locations of detentions, and the reasons officers gave for detentions.


### Detentions by Charlottesvile police officers per 1,000 residents
...
Stop and Frisk {data-orientation=rows}
=====================================
...
sf_sankeyNetwork_year <- sankeyNetwork(Links = sf_race_sfs_year, Nodes = sf_nodes_year,
                                  ...
                                  Value = "values", NodeID = "name",
                                  colourScale=sf_sankey_color, LinkGroup="group",
                                  NodeGroup="group",
...
Locations of Dententions {data-orientation=rows}
===================================== 
...
Reasons for Detentions {data-orientation=rows}
=====================================
...
sf_race <- sf_race %>%
  ...
  mutate(offense7 = case_when(
    ...
    str_detect(offense, "Narcotic|Marijuana") ~ "Narcotics Related",
...
ggplot(racetots, aes(x = offense7, fill = race, y = racetot)) +
  ...
  scale_y_continuous(labels = function(x){abs(x)}, limits = c(-130, 135))
```
