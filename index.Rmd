...
ggplot(sf_race, aes(x = type2, fill = race)) +
 ...
 geom_text(data = arrange(racetots, race), aes(x = type2, y = racetot + 5, fill = race, label = racetot), position = position_dodge(width = .85), size = 4, hjust = .5)
...
The Charlottesville policing data was acquired by attorney Jeff Fogel through Freedom of Information Act requests. The site was created by Michele Claibourn and Sam Powers in a partnership between the [Equity Center](http://virginiaequitycenter.org/) at UVA and Jordy Yager's *[Determined](https://www.vinegarhillmagazine.com/determined)* series with Vinegar Hill Magazine and Charlottesville Tomorrow. 
